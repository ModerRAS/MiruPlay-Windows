...
| 功能 | 状态 | 当前边界 |
|---|---|---|
| MLIP v1-v3 本地读取 | 完成 | 只读；校验版本、表、v3 extra capability 和路径安全 |
...
| Local/WebDAV/SMB 来源管理 | 完成 | Local、WebDAV、SMB 均支持 MLIP 只读验证、WPF/WebUI CRUD、扫描、海报、字幕与播放；远程凭据使用 CurrentUser DPAPI |
